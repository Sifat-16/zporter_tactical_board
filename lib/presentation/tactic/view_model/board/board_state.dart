...
class BoardState {
  ...
  BoardState copyWith({
    Object? itemToDelete = _sentinel,
    bool forceItemToDeleteNull = false,
    Object? selectedItemOnTheBoard = _sentinel,
    bool forceItemModelNull = false,
    Object? copyItem = _sentinel,
    bool? moveDown,
    bool? moveUp,
    Color? boardColor,
    Vector2? fieldSize,
    ...
    return BoardState(
      selectedItemOnTheBoard: forceItemModelNull == true
          ? null
          : selectedItemOnTheBoard == _sentinel
              ? this.selectedItemOnTheBoard
              : selectedItemOnTheBoard as FieldItemModel?,
      itemToDelete: forceItemToDeleteNull == true
          ? null
          : itemToDelete == _sentinel
              ? this.itemToDelete
              : itemToDelete as FieldItemModel?,
      copyItem:
          copyItem == _sentinel ? this.copyItem : copyItem as FieldItemModel?,
      moveDown: moveDown ?? this.moveDown,
      moveUp: moveUp ?? this.moveUp,
      boardColor: boardColor ?? this.boardColor,
      fieldSize: fieldSize ?? this.fieldSize,
