...
class _PlayerEditorDialogState extends State<PlayerEditorDialog> {
  late final TextEditingController _nameController;
  // --- CHANGE 1: Use a TextEditingController for the display number ---
  ...
  Future<void> _onSavePressed() async {
    ...
    final jerseyNumberText = _jerseyNumberController.text.trim();
    ...
    if (isEditMode) {
      ...
      resultPlayer = PlayerModel(
        ...
        jerseyNumber: jerseyNumberInt ??
            -1, // New player's role number is their first number
        displayNumber: jerseyNumberInt, // Display number is the same
        name: _nameController.text.trim(),
        imageBase64: _currentImageBase64,
        color: widget.playerType == PlayerType.HOME
            ? ColorManager.blueAccent
