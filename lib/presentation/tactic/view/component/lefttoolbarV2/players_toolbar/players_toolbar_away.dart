    ...
    return Column(
      children: [
        ...
        CustomButton(
          ...
          // The FULL and CORRECTED onTap handler for PlayersToolbarAway
          ...
          onTap: () {
            ...
            // --- THE FIX: Sort both lists to ensure a predictable order ---
            playersToAssign.sort((a, b) => a.role.compareTo(b.role));
