        ...
        onSave: (editedRule) {
          setState(() {
            if (isEditing) {
              ...
              // Ensure new rules have a unique name before adding
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                          ...
                          onSaved: (value) => _localConfig = _localConfig
                              .copyWith(defaultMinAndroidVersion: value)),
                      const SizedBox(height: 16),
                      _buildTextField(
                          label: 'Default Minimum iOS Version',
                          initialValue: _localConfig.defaultMinIosVersion,
                          onSaved: (value) => _localConfig = _localConfig
                              .copyWith(defaultMinIosVersion: value)),
                      const SizedBox(height: 16),
                      _buildTextField(
...
class _RuleEditorDialogState extends State<_RuleEditorDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      // --- CHANGE 1: WIDEN THE DIALOG ---
      content: SizedBox(
        width: MediaQuery.of(context).size.width *
            0.4, // Makes dialog 40% of screen width
        child: Form(
          key: _formKey,
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CheckboxListTile(
                    ...
                    activeColor: ColorManager.yellow),
                const SizedBox(height: 10), // Reduced spacing after checkboxes
                _buildTextField(
